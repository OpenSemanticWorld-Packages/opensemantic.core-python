...
from pydantic import ConfigDict, Field, PositiveFloat, conint, constr
...
class Restriction(OswBaseModel):
    model_config = ConfigDict(
        json_schema_extra={"title": "Restriction", "title*": {"en": "Relation"}},
    )
    uuid: UUID = Field(
        ..., json_schema_extra={"options": {"hidden": True}}, title="UUID"
    )
    rdf_type: str | None = Field(
        "owl:Restriction", json_schema_extra={"options": {"hidden": True}}
    )
    ...
    has_value: Item | None = Field(
        None, json_schema_extra={"range": "Category:Item"}, title="Value (Instance)"
    )
    """
...
class OwlClass(Category):
    ...
    ontologies: list[OwlOntology] | None = Field(
        None,
        json_schema_extra={"range": "Category:OSW662db0a2ad0946148422245f84e82f64"},
        title="Ontologies",
    )
    """
    Ontologies that contain this term
    ...
    field_instances: list[Item] | None = Field(
        None, alias="_instances", json_schema_extra={"range": "Category:Item"}
    )
