...
class NumberProperty(OswBaseModel):
    ...
    rdf_property: Property | None = Field(
        None,
        json_schema_extra={
            "title*": {"de": "Interne Vokabular-Zuordnung"},
            "description*": {
    ...
    external_rdf_properties: list[str] | None = Field(
        None,
        json_schema_extra={
            "title*": {"de": "Externe Vokabular-Zuordnung"},
            "description*": {
    ...
    required: bool | None = Field(
        False,
        json_schema_extra={
            "title*": {"de": "Verpflichtend"},
            "description*": {"de": "Gibt an, ob dieses Attribut erforderlich ist."},
        },
        title="Required",
    )
    """
    ...
    minimum: float | None = Field(
        ...
        json_schema_extra={
            "title*": {"de": "Minimum"},
            "description*": {"de": "Minimal erlaubter Wert (einschließlich)"},
        },
        title="Minimum",
    )
    """
    ...
    maximum: float | None = Field(
        ...
        json_schema_extra={
            "title*": {"de": "Maximum"},
            "description*": {"de": "Maximal erlaubter Wert (einschließlich)"},
        },
        title="Maximum",
    )
    """
    ...
    exclusive_minimum: float | None = Field(
        None,
        json_schema_extra={
            "title*": {"de": "Exklusives Minimum"},
            "description*": {"de": "Wert muss strikt größer als dieser sein"},
        },
    ...
    exclusive_maximum: float | None = Field(
        None,
        json_schema_extra={
            "title*": {"de": "Exklusives Maximum"},
            "description*": {"de": "Wert muss strikt kleiner als dieser sein"},
        },
    ...
    enum: list[float] | None = Field(
        None,
        json_schema_extra={
            "title*": {"de": "Erlaubte Werte"},
            "description*": {"de": "Vordefinierte Liste erlaubter Zahlenwerte"},
        },
    ...
    default: float | None = Field(
        ...
        json_schema_extra={
            ...
            "description*": {"de": "Standardwert für dieses Attribut"},
        },
        title="Default value",
    )
    """
...
class TextProperty(OswBaseModel):
    ...
    type: Literal["string"] = Field(
        "string", json_schema_extra={"options": {"hidden": "true"}}
    )
    format: Format | None = Field(
        None,
        json_schema_extra={
            "title*": {"de": "Format"},
            "description*": {"de": "Anzeige- und Validierungsformat für Textwerte"},
            "options": {
                "enum_titles": [
                    "Date (date)",
                    "Date and time (date-time)",
    ...
    min_length: conint(ge=0) | None = Field(
        None,
        json_schema_extra={
            "title*": {"de": "Mindestlänge"},
            "description*": {"de": "Mindestanzahl von Zeichen"},
        },
    ...
    max_length: conint(ge=0) | None = Field(
        None,
        json_schema_extra={
            "title*": {"de": "Maximallänge"},
            "description*": {"de": "Maximale Anzahl von Zeichen"},
        },
    ...
    enum: list[str] | None = Field(
        ...
        json_schema_extra={
            "title*": {"de": "Erlaubte Werte"},
            "description*": {"de": "Vordefinierte Liste erlaubter Werte"},
        },
        title="Allowed values",
    )
    """
...
class BooleanProperty(OswBaseModel):
    ...
    type: Literal["boolean"] = Field(
        "boolean", json_schema_extra={"options": {"hidden": "true"}}
    )
...
class LinkProperty(OswBaseModel):
    ...
    Indicates whether this property can contain multiple values.
    """
    type: Literal["iri"] = Field(
        "iri", json_schema_extra={"options": {"hidden": "true"}}
    )
    range: list[str] | None = Field(
        None,
        json_schema_extra={
            "title*": {"de": "Wertebereich für Auto-Vervollständigung"},
            "description*": {
...
class ComplexProperty(OswBaseModel):
    ...
    rdf_property: Property | None = Field(
        default_factory=lambda: Property.model_validate("Property:HasCharacteristic"),
        json_schema_extra={
            "title*": {"de": "Interne Vokabular-Zuordnung"},
            "description*": {
                "de": "Ordnet gemäß JSON-LD einem Eigenschafts-Schlüsselwort ein internes RDF-Property zu. Wird benötigt um diese Information abzufragen, etwa für tabellarische oder Graph-Ansichten. Übernimmt auch die Wertebereichs- und Datentypbeschränkungen des Propertys, falls definiert."
    ...
    type: Literal["object"] = Field(
        "object", json_schema_extra={"options": {"hidden": "true"}}
    )
...
class CharacteristicType(Entity):
    ...
    type: list[str] | None = Field(
        ...
        json_schema_extra={"options": {"collapsed": True}},
    )
    subclass_of: list[CharacteristicType] | None = Field(
        default_factory=lambda: [
            CharacteristicType.model_validate(v)
            for v in ["Category:OSW93ccae36243542ceac6c951450a81d47"]
        ],
        json_schema_extra={
            "title*": {"de": "Überkategorien (ist eine)"},
            "description*": {"de": "Elternklasse(n)"},
            "options": {
    ...
    Parent class(es)
    """
    label: list[Label] = Field(..., json_schema_extra={"propertyOrder": -1009})
    characteristics: list[CharacteristicType] | None = Field(
        None,
        json_schema_extra={
            "title*": {"de": "Charakteristiken (mixin)"},
            "description*": {
...
BooleanProperty.model_rebuild()
BudgetType.model_rebuild()
Category.model_rebuild()
CharacteristicType.model_rebuild()
City.model_rebuild()
Competence.model_rebuild()
ComplexProperty.model_rebuild()
